...
- **好感度／送禮物**：收藏牆裡點一下已經轉到的怪獸，會進到牠的專屬頁面，可以用星星買禮物（🍬 小點心 2★／🧸 小玩具 5★／💝 特別禮物 10★，禮物越貴好感度加得越多）送給牠，每隻怪獸的好感度（❤️）是分開累積的。好感度不是純數字，會實際解鎖新的互動內容：一開始只有打招呼，❤️3 解鎖「一起玩」、❤️5 解鎖「一封信」、❤️10 解鎖只有這隻怪獸才有的「小秘密」，內容會依照牠是爺爺奶奶爸爸媽媽哥哥姊姊弟弟妹妹還是寶寶而不一樣（例如寶寶會咿咿呀呀，爺爺會說很久以前的故事）。因為每隻怪獸的好感度要分開養，180 隻要全部養到最高等級是一個很長期的目標，可以讓小朋友挑幾隻特別喜歡的（例如各種怪獸的「寶寶」跟「妹妹」）花心力養好感度，而不是轉完就丟著。
