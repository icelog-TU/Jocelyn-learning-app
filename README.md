...
- **修正「著」字破音字注音錯誤**：句子裡的「著」原本不管出現在哪裡都會被自動標成「ㄓㄨˋ」（著作的音），但日常句子裡的「著」絕大多數是當「正在⋯著」的助詞用（笑著、走著、拿著、接著、跟著），應該念輕聲「ㄓㄜ˙」。現在改成預設用「ㄓㄜ˙」，只有在「著名」「著作」「顯著」「著急」「著涼」「睡著」「找著」「著陸」「著色」這幾個固定詞裡才會用回原本正確的讀音。
