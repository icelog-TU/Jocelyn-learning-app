...
- **好感度／送禮物**：收藏牆裡點一下已經轉到的怪獸，會進到牠的專屬頁面，可以用星星買禮物（🍬 小點心 2★／🧸 小玩具 5★／💝 特別禮物 10★，禮物越貴好感度加得越多）送給牠，每隻怪獸的好感度是分開累積的，用 10 顆愛心排成一排視覺化呈現（填滿幾顆就是幾點好感度），不是只顯示一個數字，讓還不太會看數字的小朋友也能直接看懂進度。好感度會實際解鎖新的互動內容：一開始只有打招呼，❤️3 解鎖「一起玩」、❤️5 解鎖「一封信」、❤️10 解鎖只有這隻怪獸才有的「小秘密」，內容會依照牠是爺爺奶奶爸爸媽媽哥哥姊姊弟弟妹妹還是寶寶而不一樣（例如寶寶會咿咿呀呀，爺爺會說很久以前的故事）。每段解鎖的互動旁邊都有「🔊 播放」按鈕，用語音唸出來，不需要自己讀文字。還沒解鎖的互動只會顯示「🔒 神秘互動」跟需要的愛心數，不會透露是哪一種互動或內容是什麼，保留驚喜感。因為每隻怪獸的好感度要分開養，180 隻要全部養到最高等級是一個很長期的目標，可以讓小朋友挑幾隻特別喜歡的（例如各種怪獸的「寶寶」跟「妹妹」）花心力養好感度，而不是轉完就丟著。送禮物的時候會有明確的「花錢」感受，而不是安安靜靜地數字變一變：按下去先播放一個下降音效，畫面上會跳出「-5⭐️」往上飄走、可用星星的數字也會一格一格往下數（不是瞬間跳掉），讓小朋友看得出來星星真的變少了；接著播放另一個心跳般的音效，跳出「+2❤️」往上飄，愛心排也會跳格子動畫填滿新的愛心，讓「星星換成愛心」這個轉換清楚地被看到、聽到。
